...
namespace daw::json {
template <> struct json_data_contract<daw::twitter::metadata_t> {
...
template <> struct json_data_contract<daw::twitter::urls_element_t> {
...
template <> struct json_data_contract<daw::twitter::url_t> {
  static inline constexpr char const urls[] = "urls";
  using type = json_member_list<json_array<urls, daw::twitter::urls_element_t>>;
...
template <> struct json_data_contract<daw::twitter::description_t> {
  static inline constexpr char const urls[] = "urls";
  using type = json_member_list<json_array<urls, daw::twitter::urls_element_t>>;
...
template <> struct json_data_contract<daw::twitter::entities_t> {
  static inline constexpr char const url[] = "url";
...
template <> struct json_data_contract<daw::twitter::user_t> {
...
template <> struct json_data_contract<daw::twitter::hashtags_element_t> {
...
template <> struct json_data_contract<daw::twitter::tweet_object_t> {
...
template <> struct json_data_contract<daw::twitter::user_mentions_element_t> {
  static inline constexpr char const screen_name[] = "screen_name";
  static inline constexpr char const name[] = "name";
  static inline constexpr char const id[] = "id";
  static inline constexpr char const id_str[] = "id_str";
...
template <> struct json_data_contract<daw::twitter::medium_t> {
...
template <> struct json_data_contract<daw::twitter::small_t> {
  static inline constexpr char const w[] = "w";
  static inline constexpr char const h[] = "h";
  static inline constexpr char const resize[] = "resize";
  using type = json_member_list<json_custom<w, std::string_view>,
...
template <> struct json_data_contract<daw::twitter::thumb_t> {
  static inline constexpr char const w[] = "w";
  static inline constexpr char const h[] = "h";
  static inline constexpr char const resize[] = "resize";
  using type = json_member_list<json_custom<w, std::string_view>,
...
template <> struct json_data_contract<daw::twitter::large_t> {
  static inline constexpr char const w[] = "w";
  static inline constexpr char const h[] = "h";
  static inline constexpr char const resize[] = "resize";
  using type = json_member_list<json_custom<w, std::string_view>,
...
template <> struct json_data_contract<daw::twitter::sizes_t> {
...
template <> struct json_data_contract<daw::twitter::media_element_t> {
  static inline constexpr char const id[] = "id";
  static inline constexpr char const id_str[] = "id_str";
  static inline constexpr char const indices[] = "indices";
...
template <> struct json_data_contract<daw::twitter::retweeted_status_t> {
  static inline constexpr char const metadata[] = "metadata";
  static inline constexpr char const created_at[] = "created_at";
  static inline constexpr char const id[] = "id";
  static inline constexpr char const id_str[] = "id_str";
...
template <> struct json_data_contract<daw::twitter::search_metadata_t> {
...
template <> struct json_data_contract<daw::twitter::twitter_object_t> {
