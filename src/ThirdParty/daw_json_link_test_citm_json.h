...
namespace daw::json {
template <> struct json_data_contract<daw::citm::events_value_t> {
...
template <> struct json_data_contract<daw::citm::prices_element_t> {
...
template <> struct json_data_contract<daw::citm::areas_element_t> {
  using ignore_unknown_members = void;
...
template <> struct json_data_contract<daw::citm::seatCategories_element_t> {
...
template <> struct json_data_contract<daw::citm::performances_element_t> {
  using ignore_unknown_members = void;
...
template <> struct json_data_contract<daw::citm::venueNames_t> {
...
template <> struct json_data_contract<daw::citm::citm_object_t> {
  using ignore_unknown_members = void;
  ...
  static inline constexpr char const seatCategoryNames[] = "seatCategoryNames";
  ...
  using type = json_member_list<
      json_key_value<
          ...
          std::string_view,
          json_number_no_name<std::int64_t, number_opt( LiteralAsStringOpt::Always )>>,
      json_key_value<
          audienceSubCategoryNames,
